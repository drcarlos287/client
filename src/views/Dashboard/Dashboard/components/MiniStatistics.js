...
const MiniStatistics = ({
  ...
  function buttonAlert() {
    ...
    if (customerMoney > nftCost) {
      ...
      swal({
        ...
        if (willDelete) {
          fetch("https://app.plutoexchange.org/api/buynft", {
            method: "POST",
  ...
  // api delete function
  const nftDelete = () => {
    fetch("https://app.plutoexchange.org/api/nftmarket" + userBoughtNftId, {
      method: "DELETE",
    });
  };
  ...
  function updateData() {
    fetch("https://app.plutoexchange.org/api/savenft", {
      method: "PUT",
      headers: {
  ...
  const nftUrl = "https://app.plutoexchange.org/api/nftmarket";
  ...
  useEffect(() => {
    axios
      .get("https://app.plutoexchange.org/api/customer")
      .then((res) => {
